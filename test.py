...
def test():
    ...
    mvsnet = MVSNet(refine = True, training = True, norm = 'gn', regular = '3DCNN')
    ...
    for i, data in enumerate(dataset.dataset):
        ...
        cv2.imwrite(scale_img_path, scale_img.astype(np.uint8)[:,:,::-1])
...
if __name__ == "__main__":
    ...
    # python test.py --max_w 1152 --max_h 864 --num_depth 192 --interval_scale 1.06
